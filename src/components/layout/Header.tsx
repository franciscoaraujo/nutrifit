...
import { faBars, faBell, faUser, faTimes, faCog } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link href="/perfil/configuracao" className="text-white hover:text-[var(--secondary)] transition-colors">
